\section{Vektorrechnung}
	...
	\subsection{Richtung eines Vektors (2D)}
	...
	\begin{minipage}{0.55\linewidth}
		\begin{tikzpicture}
			...
			\draw[very thick, red, -latex] (1,1) -- (Fy.center) node [midway, above, scale=1.2] {$\vec{v}$} node (F) {};
		\end{tikzpicture}
	\end{minipage}
	\hfill
	\begin{minipage}{0.4\linewidth}
		$$ \vec{v} = \vert v \vert \cdot \left(\frac{cos \cdot \alpha}{sin \cdot \alpha}\right) $$
	\end{minipage}
