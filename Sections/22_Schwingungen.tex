...
\subsubsection{Gedämpfte Schwingungen - Dämpfung prop. zur Geschw.}
...
\begin{minipage}{0.74\linewidth}
    ...
    mit $ \omega^2 = \dfrac{mga}{J}$ \quad $k = \dfrac{c \cdot h^2}{J}$ \quad $\omega_k = \sqrt{\omega^2 + 2 \, k}$ \\
...
% Muss sin*sin resp. cos*cos sein, anh. Buch Physik II, Seite 95, sowie Additionstheorem (z.B. IntTra Seite 3), Vorl.-Folien sind falsch
