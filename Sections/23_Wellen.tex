...
$p_H$ & Druck hinlaufende Welle & $[u_H] = Pa$ \\
$p_R$ & Druck refl. Welle & $[u_R] = Pa$ \\
$A_H$ & Ampl. hinlaufende Welle & $[u_H] = 1$ \\
$A_R$ & Ampl. refl. Welle & $[u_R] = 1$ \\
...
Pegel & $\boxed{ L_2 = L_1 - 20 \cdot \log \left( \frac{r_2}{r_1} \right)}$ \\
\end{tabular}
% \renewcommand{\arraystretch}{1}
...
Pegel & $\boxed{ L_2 = L_1 - 20 \cdot \log \left( \frac{r_2}{r_1} \right) - K (r_2 - r_1)  }$ \\
\end{tabular}
\renewcommand{\arraystretch}{1}
