\section{Dynamik}
	...
	\subsection{Rotation starrer Körper}
		...
		\subsubsection{Massenträgheitsmomente}\label{Massenträgheitsmomente}
	...
	\subsection{Rotation vs. Translation}
		\begin{center}
			\begin{adjustbox}{angle=90} % \usepackage{adjustbox} needed
				\begin{tabular}{llll}
		...
		% \includegraphics[width=0.65\linewidth]{Bilder/rotation_translation}
