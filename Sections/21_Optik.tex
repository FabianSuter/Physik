...
\\
Fluoreszenz: kein Nachleuchten \\
Phosphoreszenz: mit Nachleuchten \\
\end{minipage}
...
$\Rightarrow$ Das menschliche Auge ist bei einer Wellenlänge von $555 \, \mathrm{nm}$ \\ (grüne Farbe) am empfindlichsten. 
...
Kugel: $4 \, \pi$ \qquad $[\Omega] = \mathrm{sr}$ (Steradiant) 
\end{minipage}
...
\begin{tabular}{ll}
glatter Spiegel: & direkte Reflexion (siehe Bild oben) \\
rauher Spiegel: &diffuse Refelxion \\
\end{tabular}
...
\begin{minipage}{0.48\linewidth}
\center{ \textbf{Abbildungsgleichung} }

$$ \boxed{ \frac{1}{b} + \frac{1}{g} = \frac{1}{f} } $$
\end{minipage}
\hfill
\begin{minipage}{0.48\linewidth}
\center{ \textbf{Newtonsche Abb.-Gleichung} }
