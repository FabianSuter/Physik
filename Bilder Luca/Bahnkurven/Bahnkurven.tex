...
\begin{document}
	\begin{tikzpicture}
		...
		\fill[black] (0, 0) circle(5pt) node [midway, above, yshift=7pt] {$m$};
		\begin{scope}[xshift=2.5cm, yshift=0cm, rotate=0, scale=1]
	    	%Kräfte
			\draw [-latex, very thick, green!50!black] (0,0) -- ++(0,-2) node[midway, right] {$\vec{a}_{tangential}$};
			\draw [-latex, very thick, purple] (0,0) -- ++(-1.5,0) node[midway, above] {$\vec{a}_{radial}$};
			\draw [-latex, very thick, orange] (0,0) -- ++(-1.5,-2) node[midway, left] {$\vec{a}_{tot}$};
